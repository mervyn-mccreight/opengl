...
public class RenderLoop implements GLEventListener {
    ...
    public void init(GLAutoDrawable drawable) {
        ...
        gl2.glGenVertexArrays(1, vertexArrayId);
        gl2.glBindVertexArray(vertexArrayId.get(0));
        ...
        gl2.glBufferData(GL2.GL_ARRAY_BUFFER, vertexBufferData.length * Buffers.SIZEOF_FLOAT, FloatBuffer.wrap(vertexBufferData), GL2.GL_STATIC_DRAW);
        ...
        gl2.glBufferData(GL2.GL_ARRAY_BUFFER, normalArray.length * Buffers.SIZEOF_FLOAT, FloatBuffer.wrap(normalArray), GL2.GL_STATIC_DRAW);
    ...
    private void render(GLAutoDrawable drawable) {
        ...
        gl2.glDrawArrays(GL2.GL_TRIANGLES, 0, 12*3); // starting from 0, 12*3 vertices total
    ...
    private void update(GLAutoDrawable drawable, double deltaT) {
        ...
        gl2.glUniform3fv(lightPositionId, 1, new Vec3(8, 6, 6).getBuffer());
        ...
        gl2.glUniform1f(lightPowerId, 80f);
